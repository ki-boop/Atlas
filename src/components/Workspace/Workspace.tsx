...
export const Workspace = (item:Workspace) =>{
    ...
    const renderField = (fieldType:number)=>{
        switch (fieldType){
            case 0: return <AddField/>
            case 1: return <ChangeField/>
            case 2: return <DeleteField/>
            case 3: return <OrdersList render={false}/>
        }
    }
    return (
        ...
        <React.Fragment>
            ...
            <div className={'title-container'}>
                <div className={'title'}>
                    ...
                    <Button onClick={()=>setToggle(!toggle)}>{!toggle?item.item.logo:'✖'}</Button>
